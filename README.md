...
The IBM Data Analyst Professional Certificate is an online course program that helps the beginning learners to prepare for the entry-level data analytics career role. The learners know how to use the data analysis tools, including Excel, SQL, Python and Looker Studio (Data Visualization tool) and gain technical experiences in data cleaning, data reports, data visualizations and statistical analysis. There are 11 chapters in this online course program. 
...
- IBM Cognos Analytics Data Storytelling
...
- Chapter 2: [Excel Basics for Data Analysis](https://www.coursera.org/learn/excel-basics-data-analysis-ibm?specialization=ibm-data-analyst)

- Chapter 3: [Data Visualization and Dashboards with Excel and Cognos](https://www.coursera.org/learn/data-visualization-dashboards-excel-cognos?specialization=ibm-data-analyst)

- Chapter 4: [Python for Data Science, AI and Development](https://www.coursera.org/learn/python-for-applied-data-science-ai?specialization=ibm-data-analyst)
